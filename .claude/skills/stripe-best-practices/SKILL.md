...
description: Best practices for building Stripe integrations. Use when designing, adding, or reviewing Stripe payment/Connect/Billing flows, choosing APIs (Checkout, PaymentIntents, SetupIntents), or migrating off deprecated Stripe APIs.
---

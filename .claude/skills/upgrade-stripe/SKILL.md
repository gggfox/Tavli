---
name: upgrade-stripe
description: Guide for upgrading Stripe API versions and SDKs. Use when bumping the Stripe API version, upgrading the server SDK / Stripe.js / mobile SDKs, or assessing breaking changes between Stripe versions.
---
